...
#   の責任を負わない．
#  
#   $Id: RPCPlugin.rb 3300 2026-01-04 12:29:45Z okuma-top $
#++
...
class RPCPlugin < ThroughPlugin
  ...
  def initialize( cell_name, plugin_arg, next_cell, next_cell_port_name, next_cell_port_subscript, signature, celltype, caller_cell )
    ...
    @rpc_channel_celltype_name = "tRPCPlugin_#{@TDRCelltype}_#{@signature.get_global_name}"
    @rpc_channel_celltype_name_full = "tRPCPlugin_#{@TDRCelltype}_#{@channelCelltype}_#{@signature.get_global_name}"
...
EOT
  ...
  def gen_marshaler_celltype_ file
    file.print <<EOT
/* generated by RPCPlugin / */
generate( TransparentRPCSignaturePlugin, #{@signature.get_namespace_path}, "#{@plugin_arg_str}");
